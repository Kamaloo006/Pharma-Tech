...
function Sidebar({
  ...
  return (
    <div
      ...
      data-side={side} // 🟢 يضمن تطبيق خصائص CSS للجهة المطلوبة ديناميكياً
      data-slot="sidebar"
      style={{
        display: "flex",
        flexDirection: side === "right" ? "row-reverse" : "row", // 🟢 يقوم بقلب التدفق الهيكلي للـ Gap والـ Container معاً بشكل طبيعي
      }}
    >
      {/* الفراغ الهيكلي المحجوز للـ Sidebar */}
      <div
