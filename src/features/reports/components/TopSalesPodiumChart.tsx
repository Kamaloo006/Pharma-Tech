  ...
  return (
    ...
    >
      ...
      <CardContent className="p-4 pt-4">
        {isLoading ? (
          <div className="w-full h-87.5 flex items-end justify-between gap-4 px-6 pb-6 pt-4 animate-pulse">
            <Skeleton className="h-[40%] w-full rounded-t-lg bg-muted-foreground/20" />
            <Skeleton className="h-[75%] w-full rounded-t-lg bg-muted-foreground/20" />
            <Skeleton className="h-[55%] w-full rounded-t-lg bg-muted-foreground/20" />
            <Skeleton className="h-[90%] w-full rounded-t-lg bg-muted-foreground/20" />
            <Skeleton className="h-[30%] w-full rounded-t-lg bg-muted-foreground/20" />
            <Skeleton className="h-[65%] w-full rounded-t-lg bg-muted-foreground/20" />
          </div>
        ) : (
                ...
                <Tooltip
                  ...
                  formatter={(val: any, name: any) => {
                    if (name === "total_units_sold") {
                      return [
                        `${Number(val).toLocaleString()} ${t("reports.units")}`,
                        t("reports.soldUnits"),
                      ];
                    }
