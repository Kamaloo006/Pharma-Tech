...
export function SupplierDebtPagination({
  ...
  return (
    <div className="flex flex-col-reverse sm:flex-row items-center justify-between gap-4 py-4 px-2 border-t border-border/40">
      <div className="flex items-center gap-4 text-xs text-muted-foreground">
        <span>
          {t("common.showing", "عرض")}{" "}
      ...
      <div className="flex items-center gap-1">
        ...
        >
          <ChevronsRight className="h-4 w-4 rtl:rotate-0 rotate-180" />
        </Button>
        ...
        <Button
          ...
          disabled={currentPage === lastPage || isLoading}
        >
          <ChevronsLeft className="h-4 w-4 rtl:rotate-0 rotate-180" />
        </Button>
      </div>
    </div>
  );
